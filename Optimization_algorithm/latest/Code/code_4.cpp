...
int main(int argc, char *argv[]){
    ...
    bool print_polys = true;//If this is set to true, the positions of all remaining bonds (if there are any) will be printed to file after a finished simulation
