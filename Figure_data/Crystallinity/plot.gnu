...
fit sc_dot001(x) "Simulated_digestibility_vals.txt" u ($1):2 via a, b
...
p  	"final_saccharification_high_digestibility.txt" w p pt 5 ps 1.5 lt rgb "#00000000" title "r_{c,a} = 10^{-1}    ",\
	"Simulated_digestibility_vals.txt"  u ($1):2  pt 7 ps 1.8 lt rgb "#00000000" title "r_{c,a} = 10^{-3}    " ,\
	"final_saccharification_no_digestibility.txt" w p pt 9 ps 2 lt rgb "#00000000" title "r_{c,a} = 0        ",\
	...
	[0:90] sc_dot001(x) notitle lw 5 lt rgb "#00000000",\
